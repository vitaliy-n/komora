...
import { canningSchema, canningBulkSchema } from '../schemas/canning.js'
...
router.post('/', authMiddleware, validateBody(canningSchema), (req, res) => {
  const { id } = req.body
...
router.post('/bulk', authMiddleware, validateBody(canningBulkSchema), (req, res) => {
